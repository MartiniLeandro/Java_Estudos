...
public class ClienteController {
    ...
    @GetMapping("/email")
    public ResponseEntity<ClienteResponseDTO> getAllClientesByEmail(@RequestParam String email){
        return ResponseEntity.ok().body(clienteService.getClienteByEmail(email));
    }
