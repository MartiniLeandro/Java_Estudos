...
@Schema(description = "DTO da task que será retornado na response")
public record TaskResponseDTO(@Null @Schema(description = "ID da tarefa",requiredMode = Schema.RequiredMode.NOT_REQUIRED) Long id,
